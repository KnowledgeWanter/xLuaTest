...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public int __Gen_Delegate_Imp12(int p0, int p1, out int p2, out int p3)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public override Delegate GetDelegateByType(Type type)
		{
		    ...
		    if (type == typeof(CSharpCallLuaFunctionTest.delegate_1))
			{
			    return new CSharpCallLuaFunctionTest.delegate_1(__Gen_Delegate_Imp0);
			}
		    ...
		    if (type == typeof(CSharpCallLuaFunctionTest.delegate_2))
			{
			    return new CSharpCallLuaFunctionTest.delegate_2(__Gen_Delegate_Imp11);
			}
		
		    if (type == typeof(CSharpCallLuaFunctionTest.delegate_3))
			{
			    return new CSharpCallLuaFunctionTest.delegate_3(__Gen_Delegate_Imp12);
			}
